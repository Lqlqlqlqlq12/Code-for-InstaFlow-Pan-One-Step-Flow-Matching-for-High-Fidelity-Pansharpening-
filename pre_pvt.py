...
class PyramidVisionTransformerImpr(nn.Module):
    def __init__(self, img_size=64, patch_size=16, in_chans=4, num_classes=1000, embed_dims=[64, 128, 256, 512],
...
class net_cond(nn.Module):
    def __init__(self, class_num=2, in_chans = 4,mask_chans=0, **kwargs):
        super(net_cond, self).__init__()
        self.class_num = class_num
        self.backbone = pvt_v2_b2(in_chans=in_chans, mask_chans=mask_chans)
    ...
    def _init_weights(self):
        ...
        weights_path = '/data0/pvt/pvt_v2_b2.pth'  # 本地模型路径
        pretrained_dict = torch.load(weights_path, map_location='cpu')  # 或 'cuda' 取决于你的设备
